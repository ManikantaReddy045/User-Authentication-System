...
class CustomRegisterSerializer(RegisterSerializer):
    ...
    firstname= serializers.CharField(required=True,validators=[alphabits],max_length=30)
    lastname=serializers.CharField(required=True,validators=[alphabits],max_length=30)
    PhoneNumber=serializers.CharField(required=True,max_length=30)
